...
//  DreamLister
//
//  Created by Guilherme Ruiz on 26/01/17.
...
class MainVC: UIViewController, UITableViewDelegate,
    ...
    func generateTestData(){
        ...
        item.price = 1800
        item.details = "New MacBook Pro 2017"
        
        let item2 = Item(context: context)
        item2.title = "Bose Headphones"
        item2.price = 300
        item2.details = "With noise canceling tech"
        
        let item3 = Item(context: context)
        item3.title = "Tesla Model S"
        item3.price = 110000
        item3.details = "Awesome car"
        
        //Persist all data in context
